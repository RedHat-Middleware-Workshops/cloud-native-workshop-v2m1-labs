...
insert into INVENTORY (itemId, link, location, quantity) values ('444437', 'http://maps.google.com/?q=Tokyo', 'Tokyo', 300);
...
-- insert into PRODUCT_CATALOG (itemId, name, description, price) values ('444437', 'Atari 2600 Joystick', 'Based on the original design of the joystick controller for the famed Atari 2600 console, the Joystick from Retro-Bit features a similar stick and single-button layout. ', 240.00);
